...
Implementation of the low level serial protocol for the model TC-36-25
thermoelectric cooler temperature controller. The low level interface
implements the basic serial protocol as outlined in the TC-36-25
Operation Manual.
